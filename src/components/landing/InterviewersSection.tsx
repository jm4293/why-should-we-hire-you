            ...
            >
              ...
              <blockquote
                className={cn(
                  ...
                  item.color.includes("gray-900") ? "text-gray-300" : "text-gray-600"
                )}
              >
              ...
              <p
                className={cn(
                  "text-xs",
                  item.color.includes("gray-900") ? "text-gray-500" : "text-gray-400"
                )}
              >
                <span
                  className={cn(
                    "font-medium",
                    item.color.includes("gray-900") ? "text-gray-400" : "text-gray-500"
                  )}
                >
                  중점 평가 :
                </span>{" "}
